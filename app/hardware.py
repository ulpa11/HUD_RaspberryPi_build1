    ...
    while True:
        ...
        if (x['Tube Name'] == 'A'):
            ...
            while (state == True):
                ...
                # reading Sensor Data
                ser1 = serial.Serial(port='/dev/ttyUSB1', baudrate=115200)  # open serial port
        ...
        # Condition for TUBE-B
            ...
            while (state == True):
                ...
                # reading Sensor Data
                ser2 = serial.Serial(port='/dev/ttyUSB3', baudrate=115200)  # open serial port
